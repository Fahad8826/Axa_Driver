...
//       //   startLocationService().catchError((e) {
//       //     print('[Auth] Location service start failed: $e');
//       //   });
//       // });
...
class AuthController extends GetxController {
  ...
  // ── ADMIN CONTACT ─────────────────────────────────────────────────────────
  static const String _adminWhatsApp = '919999999999';
  ...
  Future<void> contactAdmin() async {
    ...
    if (await canLaunchUrl(whatsappUri)) {
      ...
      AppFeedback.error('Could not open WhatsApp. Please contact your admin directly.');
    }
  }
